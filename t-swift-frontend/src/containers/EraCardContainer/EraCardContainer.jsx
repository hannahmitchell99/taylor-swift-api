...
const EraCardContainer = ({eras}) => {
    ...
    const erasJSX = eras.map((era) => {
        return <EraCard inspiration = {era.eraInspiration} name = {era.albumOfEra.name}  eraIconicQuote = {era.eraIconicQuote} albumCover = {era.albumOfEra.cover} genre = {era.albumOfEra.genre}eraID = {era.eraID} key = {era.eraID} />
    })
